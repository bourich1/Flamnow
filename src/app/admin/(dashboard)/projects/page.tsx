...
export default function ProjectsAdminPage() {
  ...
  const handleAddNew = () => {
    ...
    setFormResults('Outcome metric 1\nOutcome metric 2')
    setFormTags('Branding, Creative code')
    setFormColor('#ED3F27')
  ...
  const validateForm = () => {
    ...
    if (!formDescription.trim()) errors.description = 'Short description is required.'
    ...
    // Character limits
    if (formTitle.length > 60) errors.title = 'Title must be 60 characters or less.'
    if (formClient.length > 40) errors.client = 'Client name must be 40 characters or less.'
    if (formTagline.length > 100) errors.tagline = 'Tagline must be 100 characters or less.'
    if (formDescription.length > 200) errors.description = 'Short description must be 200 characters or less.'
    ...
    try {
      if (editingId) {
        ...
        const { error } = await supabase
          ...
          .insert([payload])
        if (error) throw error
        setSuccessMsg('New project case study created.')
    ...
    <div className="space-y-8 select-none">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/5">
        <div>
          ...
          <p className="text-xs text-white/60 mt-1">
            Create, update, and manage case study narratives. Previews update in real-time.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Main Registry Selector + Form Editor (Left column: 8cols) */}
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 border-b border-white/5 pb-3">
                ...
                <div className="relative w-full sm:max-w-xs">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 rounded-lg border border-white/5 bg-[#0b0b0b] text-[11px] text-white focus:outline-none focus:border-[#00E5FF]/40"
                  />
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="bg-surface-base border border-border-theme p-6 rounded-2xl space-y-5">
              <div className="flex items-center justify-between border-b border-border-theme pb-2">
                <h3 className="text-xs font-mono uppercase tracking-widest text-[#00E5FF] font-bold">
                  {editingId ? 'Edit Selected Project Parameters' : 'Register New Case Study'}
                </h3>
                {editingId && (
                  <button
                    type="button"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground placeholder-white/20 focus:outline-none focus:border-[#00E5FF]/50 transition-all font-mono disabled:opacity-40"
                  />
                  {validationErrors.id && (
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground focus:outline-none focus:border-[#00E5FF]/50 transition-all"
                  />
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground focus:outline-none resize-none"
                />
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground focus:outline-none resize-none font-mono"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-grow px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground focus:outline-none font-mono"
                  />
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <input
                      ...
                      value={formColor}
                      onChange={(e) => updateFormColor(e.target.value)}
                      className="flex-1 px-4 py-2.5 rounded-xl border border-border-theme bg-bg-base text-xs text-foreground font-mono focus:outline-none"
                    />
                  </div>
          ...
          {/* Real-time Project Card Preview (Right column: 4cols) */}
